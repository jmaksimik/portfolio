    ...
    return (
        <div className='container max-w-full bg-slate-200 drop-shadow-sm py-10' id='AboutMe'>
            ...
            <div className='flex flex-row flex-wrap justify-center mt-10 ml-10 gap-20'>
                <p className='text-left inline-block w-96 mt-4 font-thin text-lg mr-10 '>I'm John Maksimik, a full-stack software developer who loves solving complex business problems. 
